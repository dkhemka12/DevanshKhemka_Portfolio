    ...
    <>
      <div ref={ctaRef} className="transition-colors duration-300 mix-blend-difference">
        <div className="main-container py-20 lg:py-28 h-full flex flex-col gap-8 justify-center items-center">
          <h4 className='max-w-6xl text-2xl md:text-3xl xl:text-[40px] 2xl:text-5xl text-center leading-[1.25] mix-blend-difference'>{profile.ctaTitle}</h4>
          <GradientButton text="Let's Connect" link="/booking" />
        </div>
      </div>
    </>
  )
